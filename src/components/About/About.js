    ...
    return (
      <div className="about-section">
        <div className="item text-container">
          ...
          <p className="text-container__copy">This React app was built from "Create React App" on Webpack to consume API data served from a Adobe Experience Manager (AEM) provided endpoint. Learn more, please visit the following blog posts:</p>
          <br/>
